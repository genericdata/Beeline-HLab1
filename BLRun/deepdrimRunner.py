...
def generateInputsForPredict(RunnerObj,algName,trainingPairsInputDir):
    ...
    if not RunnerObj.inputDir.joinpath(algName,"predict_pairs"+algName+".txtTF_divide_pos.txt").exists():
        ...
        #ExpressionData.to_csv(RunnerObj.inputDir.joinpath(algName,"ExpressionData.csv"),
        ...
        predictPairs.to_csv(RunnerObj.inputDir.joinpath(algName,"predict_pairs"+algName+".txt"),
                                      sep='\t',header=False,index=False)
        ...
        np.savetxt(RunnerObj.inputDir.joinpath(algName,"predict_pairs"+algName+".txtTF_divide_pos.txt"),predictDividePos,fmt='%d')
...
def run(RunnerObj):
    runForPredict(RunnerObj,'DEEPDRIM',RunnerObj.fullInputDir)
